...
const categories = [
  ...
  { key: 'rules', label: 'Business Rules', icon: ShieldCheck },
    ...
    <div className="p-6 lg:p-8 space-y-6 max-w-7xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage your AI agents knowledge</p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" className="gap-2"><Upload className="h-4 w-4" /> Upload Document</Button>
