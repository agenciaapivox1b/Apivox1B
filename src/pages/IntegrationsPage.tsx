...
const logs = [
  { id: '1', integration: 'n8n Webhook', event: 'Lead synced', status: 'success', timestamp: '2026-03-05T14:00:00Z' },
  { id: '2', integration: 'CRM', event: 'Contact updated', status: 'success', timestamp: '2026-03-05T13:30:00Z' },
  { id: '3', integration: 'n8n Webhook', event: 'Workflow triggered', status: 'success', timestamp: '2026-03-05T12:00:00Z' },
  { id: '4', integration: 'Google Calendar', event: 'Connection failed', status: 'error', timestamp: '2026-03-05T10:00:00Z' },
];
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 max-w-7xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Connect your tools and services</p>
      </div>
            ...
            <Card key={intg.id} className="bg-card border-border">
              <CardContent className="p-5">
                ...
                <div className="flex items-center justify-between mt-4">
                  <Badge variant="outline" className={`text-xs ${intg.status === 'connected' ? 'text-brand-green-secondary border-brand-green-secondary/20' : intg.status === 'error' ? 'text-destructive border-destructive/20' : 'text-muted-foreground'}`}>
                    {intg.status}
                  </Badge>
      ...
      <Card className="bg-card border-border">
        <CardContent className="p-5">
          <h3 className="font-medium text-foreground text-sm mb-4">Recent Events</h3>
